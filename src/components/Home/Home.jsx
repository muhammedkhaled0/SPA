...
export default function Home() {
  return (
    <>
    <div className='home bg-[#1ABC9C] py-5 h-screen flex flex-col items-center justify-center'>
      <img src={avatar} alt=""  className='w-60'/>
      <h1 className='font-bold text-4xl mt-6 text-white'>START FRAMEWORK</h1>
